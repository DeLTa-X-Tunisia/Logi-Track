...
const defaultTranslations = {
  ...
  'dashboard.vue_ensemble': "Vue d'ensemble de la production API 5L",
  'dashboard.actualiser': 'Actualiser',
  'dashboard.reessayer': 'Réessayer',
  'dashboard.erreur_chargement': 'Impossible de charger les données du dashboard',
  'dashboard.tubes_en_cours': 'Tubes en cours',
  'dashboard.tubes_termines': 'Tubes terminés',
  'dashboard.certifie_api': 'Certifié API',
  'dashboard.certifie_hydraulique': 'Certifié Hydraulique',
  'dashboard.du_total': 'du total',
  'dashboard.rebuts': 'Rebuts',
  'dashboard.total_tubes': 'Total tubes',
  'dashboard.crees_aujourdhui': "créé(s) aujourd'hui",
  'dashboard.aujourdhui': "aujourd'hui",
  'dashboard.taux_rebut': 'taux de rebut',
  'dashboard.en_reparation': 'en réparation',
  ...
  'dashboard.bobines': 'Bobines',
  'dashboard.coulees': 'Coulées',
  'dashboard.voir_tout': '→ Voir tout',
  'dashboard.en_stock': 'En stock',
  'dashboard.en_cours_utilisation': "En cours d'utilisation",
  'dashboard.poids_total': 'Poids total',
  'dashboard.en_production': 'En production',
  'dashboard.en_preparation': 'En préparation',
  'dashboard.pretes': 'Prêtes',
  'dashboard.en_cours': 'En cours',
  'dashboard.consommees': 'Consommées',
  ...
  'dashboard.il_y_a_min': 'Il y a {n} min',
  'dashboard.il_y_a_h': 'Il y a {n}h',
  'dashboard.il_y_a_j': 'Il y a {n}j',
